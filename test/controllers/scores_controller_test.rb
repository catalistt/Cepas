...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { enologist_id: @score.enologist_id, grade: @score.grade, wine_id: @score.wine_id } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { enologist_id: @score.enologist_id, grade: @score.grade, wine_id: @score.wine_id } }
